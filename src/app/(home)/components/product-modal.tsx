...
const ProductModal = ({ product }: { product: Product }) => {
    ...
    const alreadyHasInCart = useMemo(() => {
        ...
        return cartItems.some((item: CartItem) => item.hash === hash)

    }, [product, cartItems, chosenConfig, selectedToppings])
            ...
            <DialogContent className="max-w-3xl p-0">
                <div className="flex">
                    ...
                    <div className="w-2/3 p-8">
                        ...
                        {/* TODO: make this condition dynamic (add hasTooping feild in category document) */}
                        {
                        ...
                        <div className="flex justify-between items-center mt-12">
                            ...
                            <Button className={alreadyHasInCart ? "bg-gray-800" : 'bg-primary'} disabled={alreadyHasInCart} onClick={() => handleAddToCart(product)}>
